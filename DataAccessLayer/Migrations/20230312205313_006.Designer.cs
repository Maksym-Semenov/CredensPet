...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BranchBranch", b =>
                {
                    b.Property<string>("BranchesListBranchName")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ListBranchesBranchName")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("BranchesListBranchName", "ListBranchesBranchName");

                    b.HasIndex("ListBranchesBranchName");
            ...
            modelBuilder.Entity("BranchBranch", b =>
                {
                    b.HasOne("DataAccessLayer.Models.Branch", null)
                        .WithMany()
                        .HasForeignKey("BranchesListBranchName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessLayer.Models.Branch", null)
                        .WithMany()
                        .HasForeignKey("ListBranchesBranchName")
