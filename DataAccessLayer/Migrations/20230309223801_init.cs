    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactProjects", x => x.ContactId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactsUsers", x => x.ContactId);
                    table.ForeignKey(
                        name: "FK_ContactsUsers_Users_UserId",
                        column: x => x.UserId,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
